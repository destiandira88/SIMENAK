<?php
/**
 * @var list<array{label: string, value: int|string, icon: string, color: string, isText?: bool}> $cards
 */
$iconPaths = [
    ...
    <?php foreach ($cards as $card): ?>
        ...
        <div class="card p-6 flex items-center gap-4">
            ...
            <div class="min-w-0">
                ...
                <p class="<?= $isText ? 'text-lg' : 'text-3xl' ?> font-extrabold truncate" style="color:var(--navy);">
