    ...
    <div class="flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between mb-4">
        <div>
            ...
            <p class="text-sm text-slate-500 mt-0.5">
                Deadline pesanan aktif-klik tanggal atau item untuk detail. Hanya tampilan monitoring.
            </p>
        </div>
...
.cal-day.today .cal-date { color: #5B21B6; }
.cal-day.has-deadline { cursor: pointer; }
.cal-day.other-month .cal-date { color: #CBD5E1; }
.cal-day.selected { background: #051747 !important; }
.cal-day.selected .cal-date { color: #fff !important; }
.cal-date {
  font-size: 12px;
  font-weight: 600;
  color: #475569;
...
.dot-terverifikasi  { background: #3B82F6; }
.dot-proses_desain  { background: #6366F1; }
.dot-proses_revisi  { background: #F59E0B; }
.dot-proses_cetak   { background: #8B5CF6; }
.dot-finishing      { background: #14B8A6; }
