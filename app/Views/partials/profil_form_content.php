            ...
            <?php if ($verifikasiTerbaru !== null): ?>
                <dl class="grid grid-cols-1 gap-2 text-xs">
                    <?php if (!empty($verifikasiTerbaru['jabatan_pic'])): ?>
                        <div><dt class="font-semibold text-emerald-800">Jabatan PIC</dt><dd><?= esc((string) $verifikasiTerbaru['jabatan_pic']) ?></dd></div>
                    <?php endif; ?>
                    <?php if (!empty($verifikasiTerbaru['wa_perusahaan'])): ?>
                        <div><dt class="font-semibold text-emerald-800">WA Perusahaan</dt><dd><?= esc((string) $verifikasiTerbaru['wa_perusahaan']) ?></dd></div>
                    <?php endif; ?>
                    <?php if (!empty($verifikasiTerbaru['alamat_kantor'])): ?>
                        <div><dt class="font-semibold text-emerald-800">Alamat Kantor</dt><dd><?= esc((string) $verifikasiTerbaru['alamat_kantor']) ?></dd></div>
                    <?php endif; ?>
                </dl>
            <?php endif; ?>
        </div>
