...
<form method="get" action="<?= esc(site_url('laporan-produksi')) ?>" class="flex flex-wrap gap-3 items-end mb-6">
    <div>
...
<p class="text-xs text-slate-400 italic mt-4">
    Hanya mencakup pesanan aktif dari tahap terverifikasi hingga finishing. Pesanan selesai atau dikirim tidak dihitung.
