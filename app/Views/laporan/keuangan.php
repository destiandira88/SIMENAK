...
<form method="get" action="<?= esc(site_url('laporan-keuangan')) ?>" class="flex items-center justify-end gap-3 mb-6">
    <div class="relative">
        <button
            type="button"
            id="laporanKeuanganFilterToggle"
            class="btn-laporan-filter"
            aria-expanded="false"
            aria-controls="laporanKeuanganFilterPanel"
            aria-haspopup="true">
        ...
        <div id="laporanKeuanganFilterPanel" class="laporan-admin-filter-panel hidden">
            ...
            <div class="filter-field">
                ...
                <select id="jenis" name="jenis" class="border border-slate-200 rounded-[14px] px-3 py-2 text-sm min-w-0 focus:border-[#2E5CE6] focus:outline-none focus:ring-2 focus:ring-[rgba(46,92,230,0.1)]">
...
<div class="admin-data-table-wrap mb-6 mt-6">
    <div class="px-6 py-4 border-b border-slate-100">
        ...
        <p class="text-xs text-slate-500 mt-0.5">
            Menampilkan rekap transaksi terverifikasi pada periode yang dipilih. Nilai rata-rata dihitung dari total nominal dibagi jumlah transaksi.
        </p>
    </div>
...
<script>
    (() => {
        const toggle = document.getElementById('laporanKeuanganFilterToggle');
        const panel = document.getElementById('laporanKeuanganFilterPanel');
        if (!toggle || !panel) {
            return;
        }
